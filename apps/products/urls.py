...
urlpatterns = [
    ...
    # Pincode availability APIs
    path('api/check-pincode/', views.check_pincode_availability, name='check_pincode'),
    path('api/validate-pincode/', views.validate_pincode, name='validate_pincode'),
